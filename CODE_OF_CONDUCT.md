...
- showing professional courtesy in public and private project spaces.
...
- deliberately sharing credentials, tokens, tenant data, or other sensitive
  information; and
...
standards. They may remove, edit, or reject comments, commits, code, wiki
edits, issues, and other contributions that do not align with this Code of
Conduct. Maintainers will communicate reasons for moderation decisions when it
is appropriate and safe to do so.

## Scope

This Code of Conduct applies within all project spaces and when an individual
is officially representing the project in public spaces. Examples include using
an official project email address, posting through an official social-media
...
Maintainers will follow these Community Impact Guidelines when determining a
response:

1. **Correction** — A private, written warning that explains the violation and
   why the behaviour was inappropriate.
...
4. **Permanent ban** — A permanent ban from any public interaction with the
   project.
